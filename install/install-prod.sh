...
touch images
echo "k8s.gcr.io/kube-apiserver:v1.12.2=registry.cn-hangzhou.aliyuncs.com/google_containers/kube-apiserver-amd64:v1.12.2" > images
...
echo "k8s.gcr.io/kube-controller-manager:v1.12.2=registry.cn-hangzhou.aliyuncs.com/google_containers/kube-controller-manager-amd64:v1.12.2" >> images
echo "k8s.gcr.io/kube-scheduler:v1.12.2=registry.cn-hangzhou.aliyuncs.com/google_containers/kube-scheduler-amd64:v1.12.2" >> images
echo "k8s.gcr.io/kube-proxy:v1.12.2=registry.cn-hangzhou.aliyuncs.com/google_containers/kube-proxy-amd64:v1.12.2" >> images
